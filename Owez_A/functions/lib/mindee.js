...
exports.parseReceiptWithMindee = parseReceiptWithMindee;
const MINDEE_ENDPOINT = 'https://api.mindee.net/v1/products/mindee/generated/v1/predict';
async function parseReceiptWithMindee(args) {
    const { apiKey, fileBytes, fileName = 'receipt.jpg' } = args;
    if (!apiKey)
        throw new Error('Missing Mindee API key');
...
//# sourceMappingURL=mindee.js.map